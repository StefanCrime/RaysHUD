...
C:\Program Files\Steam\steamapps\<youraccoutname>\team fortress 2\

Replace <YOURSTEAMID> with your steamID, the one you log in with

It should merge with the existing tf folder in that location, it will not erase the content in
the folder

To play it, open TF2, press "Create server" and in map choose "tr_walkway_rc". Be sure to
