STEFAN B.'s HUD (RaysHUD modified)

Step-by-step instructions:

1. Use WinRAR to extract the files.
2. Create a custom folder inside your tf. (C:\Program Files (x86)\Steam\steamapps\common\Team Fortress 2\tf\)
3. Copy-Paste the inside of the entire folder inside the custom folder. (Example: C:\Program Files (x86)\Steam\steamapps\common\Team Fortress 2\tf\custom)
